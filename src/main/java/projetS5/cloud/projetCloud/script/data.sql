...
('Automatique'),
('Manuelle'),
('Transmission variation continu'),
('Semi-automatique'),
('4 roues motrices');
...
('Freins à disque'),
('Freins à tambour'),
('Systeme freinage antiblocage'),
('Freinage d urgence assiste'),
('Frein stationnement electro');
...
('VOIT0006', 'EQP_IN0001'), -- Première voiture avec système de navigation GPS
('VOIT0007', 'EQP_IN0002'), -- Deuxième voiture avec climatisation automatique
('VOIT0008', 'EQP_IN0003'), -- Troisième voiture avec sièges en cuir chauffants
('VOIT0009', 'EQP_IN0004'), -- Quatrième voiture avec toit ouvrant panoramique
('VOIT0010', 'EQP_IN0005'); -- Cinquième voiture avec système audio haut de gamme


-- Insertion de données dans la table voiture_prix
INSERT INTO voiture_prix (prix, date, voiture_id) VALUES
(25000.00, '2022-01-01', 'VOIT0006'),
(28000.00, '2022-02-15', 'VOIT0007'),
(22000.00, '2022-03-20', 'VOIT0008'),
(30000.00, '2022-04-10', 'VOIT0009'),
(35000.00, '2022-05-05', 'VOIT0010');
